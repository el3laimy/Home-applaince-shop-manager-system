...
// Auto-apply migrations and seed foundational data in every environment.
using (var scope = app.Services.CreateScope())
{
    ...
    // Optional: Preload cache on startup. Redis failures should not block API boot.
    try
    {
    ...
    {
        app.Logger.LogWarning(ex, "Product cache preload failed during startup.");
    }
}
