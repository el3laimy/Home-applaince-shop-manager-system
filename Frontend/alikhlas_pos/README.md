...
- `schemaVersion` الحالي: 9.
- v5 أضاف `products.imagePath` لتخزين مسار صورة المنتج الداخلية، وv6 أضاف مستندات تسوية الجرد، وv7 أضاف الأرصدة الافتتاحية، وv8 أضاف مستندات مرتجع المشتريات وبنودها، وv9 أضاف مستندات تصحيح الخزينة والمحفظة.
