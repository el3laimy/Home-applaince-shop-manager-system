...
part 'auth/v2_initial_owner_screen.dart';
part 'auth/v2_login_screen.dart';
part 'auth/v2_recovery_access_dialog.dart';
part 'auth/v2_change_password_screen.dart';
part 'shell/v2_shell.dart';
part 'features/v2_daily_view.dart';
part 'features/v2_pos_view.dart';
part 'features/v2_pos_actions.dart';
...
part 'features/v2_backup_view.dart';
part 'features/v2_integrity_audit_dialog.dart';
part 'features/v2_settings_view.dart';
...
part 'shared/v2_quick_installment_dialog.dart';
part 'shared/v2_sale_receipt_dialog.dart';
part 'shared/v2_party_dialog.dart';
part 'shared/v2_installment_payment_dialog.dart';
part 'shared/v2_sale_return_dialog.dart';
part 'shared/v2_purchase_return_dialog.dart';
