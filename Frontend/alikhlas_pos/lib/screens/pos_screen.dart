    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'يرجى إدخال عهدة الدرج المبدئية لبدء المبيعات',
...
class _PosScreenState extends State<PosScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (shiftCtrl.isLoading.value &&
          !shiftCtrl.hasActiveShift.value &&
              ...
              children: [
                ...
                Expanded(
                  child: Row(
                    children: [
                      // ===== LEFT: Cart Panel =====
                      Expanded(flex: 2, child: _buildCartPanel(isDark)),
                      // ===== RIGHT: Product Grid =====
                      Expanded(flex: 5, child: _buildProductPanel(isDark)),
                    ],
                  ),
                ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      _ShortcutHint(label: 'بحث', shortcut: 'F2'),
                      const SizedBox(width: 24),
                      _ShortcutHint(label: 'خصم', shortcut: 'F4'),
                      const SizedBox(width: 24),
                      _ShortcutHint(label: 'دفع', shortcut: 'F12'),
                      const SizedBox(width: 24),
                      _ShortcutHint(label: 'مسح السلة', shortcut: 'Esc'),
                    ],
                  ),
                ),
              ],
                ...
                child: DesignTokens.liquidBorderCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'لا يمكن التحقق من حالة الوردية الحالية. يرجى التأكد من تشغيل الخادم والاتصال بالشبكة.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
      ...
      if (!shiftCtrl.hasActiveShift.value) {
        return Stack(
          children: [
            ...
            // Overlay Dialog
            Container(color: Colors.black54),
            Center(child: _OpenShiftOverlay(shiftCtrl: shiftCtrl)),
          ],
        );
      }
              ...
              child: name.isEmpty
                  ...
                  : Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: const Color(0xFF27AE60).withAlpha(80),
                        ),
                      ),
                      child: Row(
                        children: [
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return _CartItemCard(
                    ...
                    index: index,
                    onEditPrice: () =>
                        _showEditPriceDialog(index, _ctrl.cartItems[index]),
                  );
                },
              );
            }),
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                  ...
                  TextButton(
                    ...
                    child: Text(
                      _ctrl.globalDiscount.value > 0
                          ...
                          : 'إضافة خصم',
                      style: TextStyle(
                        color: _ctrl.globalDiscount.value > 0
                            ? Colors.redAccent
              ...
              // ── Utility Row: Reprint + Print Test ──
              Obx(() {
                // Access an observable safely so GetX registers it, even if hasLastReceipt is false.
                // .value must be called inside the Obx builder.
                final hasReceipt = _ctrl.hasLastReceipt;
                // Also access another observable just in case hasLastReceipt isn't observable
                final _ = _ctrl.cartItems.length;
                ...
                return Row(
                  children: [
                        ...
                        child: _MiniActionButton(
                          ...
                          onPressed: () async {
                            ...
                            if (mounted) {
                              Get.snackbar(
                                'طباعة',
                                'تم إرسال الفاتورة ${_ctrl.lastInvoiceNo.value ?? ''} للطابعة',
                    ...
                    if (hasReceipt) const SizedBox(width: 6),
                    Expanded(
                      child: _MiniActionButton(
                ...
                children: [
                  ...
                  Expanded(
                    child: _CheckoutButton(
                      ...
                      onPressed: _ctrl.cartItems.isEmpty
                          ? null
                ...
                children: [
                  ...
                  Expanded(
                    child: _CheckoutButton(
                      ...
                      onPressed: () {
                        _ctrl.selectedPaymentType.value =
                  ...
                  Expanded(
                    child: _CheckoutButton(
                      ...
                      onPressed: () {
                        _ctrl.selectedPaymentType.value = PaymentType.cash;
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return _ProductCard(
                      ...
                      onTap: () => _ctrl.addProductToCart(
                        _ctrl.quickAccessProducts[index],
                      ),
                    );
                  },
                );
  ...
  void _showDiscountDialog() {
    final TextEditingController dCtrl = TextEditingController(
      text: _ctrl.globalDiscount.value > 0
          ? _ctrl.globalDiscount.value.toStringAsFixed(2)
          : '',
    );
    Get.dialog(
      AlertDialog(
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (discountVal > _ctrl.subtotal) {
                Get.snackbar(
                  'تنبيه',
                  'الخصم لا يمكن أن يتجاوز المجموع الفرعي (${_ctrl.subtotal.toStringAsFixed(2)} ج.م)',
                  backgroundColor: Colors.orange,
                  colorText: Colors.white,
                );
                return;
  ...
  void _showEditPriceDialog(int index, CartItemModel item) {
    final TextEditingController pCtrl = TextEditingController(
      text: (item.customPrice ?? item.unitPrice).toString(),
    );
    Get.dialog(
      AlertDialog(
  ...
  void _showNotificationsOverlay(BuildContext context) {
    showDialog(
      context: context,
      builder: (_) => ZReportDialog(shiftCtrl: Get.find<ShiftController>()),
    );
  }
  ...
  void _showInstallmentDialog() {
    if (_ctrl.selectedCustomerId.value == null) {
      Get.snackbar(
        'تنبيه',
        'يجب اختيار عميل أولاً لإنشاء خطة تقسيط',
        backgroundColor: Colors.orange,
        colorText: Colors.white,
      );
      return;
    ...
    Get.dialog(
      StatefulBuilder(
        builder: (ctx, setState) {
          ...
          final perInstallment = installmentCount > 0
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        helperText:
                            'مثال: 12 قسط ${periodLabels[selectedPeriod]}',
                      ),
                    ),
                  ],
                ),
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  if (down >= _ctrl.total) {
                    Get.snackbar(
                      'خطأ',
                      'المقدم لا يمكن أن يساوي أو يتجاوز الإجمالي',
                      backgroundColor: Colors.red,
                      colorText: Colors.white,
                    );
                    return;
                  ...
                  await _ctrl.confirmCheckout(
                    ...
                    firstInstallmentDate: DateTime.now().add(
  ...
  void _showSplitPaymentDialog() {
    ...
    final cashCtrl = TextEditingController(
      text: _ctrl.total.toStringAsFixed(2),
    );
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  if ((cash + visa - _ctrl.total).abs() > 0.1) {
                    Get.snackbar(
                      'خطأ',
                      'مجموع المبلغين يجب أن يساوي الفاتورة',
                      backgroundColor: Colors.red,
                      colorText: Colors.white,
                    );
                    return;
                  ...
                  Get.back();
                  _ctrl.confirmCheckout(
                    splitCashAmount: cash,
                    splitVisaAmount: visa,
                  );
                  FocusScope.of(context).requestFocus(_barcodeFocusNode);
                },
                child: const Text(
    ...
    Future<void> search(String q) async {
      ...
      try {
        final url = q.isNotEmpty
            ? 'customers?search=${Uri.encodeComponent(q)}'
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return ListTile(
                        ...
                        onTap: () {
                          ...
                          ctrl.selectedCustomerName.value =
                              c['name'] as String?;
                          Get.back();
                        },
                      );
          ...
          children: [
            ...
            Row(
              children: [
                _buildQtyBtn(
                  Icons.remove,
                  () => ctrl.updateQuantity(index, item.quantity - 1),
                  isDark,
                ),
                Padding(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected
              ? DesignTokens.glowShadow(DesignTokens.neonPurple, blur: 10)
              : [],
        ),
        child: Row(
          children: [
            Icon(
              icon,
              color: isSelected
                  ? (isDark ? DesignTokens.neonPurple : Colors.white)
                  : Colors.grey[500],
              size: 18,
            ),
            const SizedBox(width: 8),
...
class _ProductCardState extends State<_ProductCard> {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final imageBaseUrl =
        (dotenv.env['API_BASE_URL'] ?? 'http://localhost:5291/api').replaceAll(
          '/api',
          '',
        );
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _isHovered
                  ? (isDark
                        ? DesignTokens.neonCyan.withAlpha(80)
                        : AppTheme.primaryColor.withAlpha(80))
                  : (isDark
                        ? Colors.white.withAlpha(8)
            ...
            boxShadow: [
              BoxShadow(
                color: _isHovered
                    ? (isDark
                          ? DesignTokens.neonCyan.withAlpha(40)
                          : AppTheme.primaryColor.withAlpha(30))
                  ...
                  children: [
                    ClipRRect(
                      borderRadius: BorderRadius.vertical(
                        top: Radius.circular(DesignTokens.kCardRadius),
                      ),
                      child:
                          ...
                          ? Image.network(
                              ...
                              errorBuilder: (_, __, ___) =>
                                  _placeholder(isDark, widget.product.name),
                            )
                          : _placeholder(isDark, widget.product.name),
                    ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: widget.product.stockQuantity <= 0
                                ...
                                : DesignTokens.neonRed.withAlpha(200),
                            borderRadius: BorderRadius.circular(6),
                          ),
                          child: Text(
                            widget.product.stockQuantity <= 0
                                ? 'نفد المخزون'
                                : 'باقي ${widget.product.stockQuantity.toInt()}',
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 9,
                              fontWeight: FontWeight.bold,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            if (widget.product.internalBarcode != null)
                              Text(
                                widget.product.internalBarcode!,
                                style: TextStyle(
                      ...
                      Row(
                        children: [
                          if (widget.product.wholesalePrice > 0 &&
                            ...
                            Text(
                              '${widget.product.wholesalePrice.toStringAsFixed(0)} ',
                              style: TextStyle(
                                color: Colors.grey[500],
                                fontSize: 10,
                            ...
                            decoration: BoxDecoration(
                              color: _isHovered
                                  ...
                                  : (isDark
                                        ...
                                        : DesignTokens.neonGreen.withAlpha(20)),
                              shape: BoxShape.circle,
                            ),
                            child: Icon(
                              Icons.add_rounded,
  ...
  Widget _placeholder(bool isDark, String name) {
    if (name.isNotEmpty) {
      ...
      if (words.length > 1) {
        ...
        initials = words[0].substring(0, words[0].length >= 2 ? 2 : 1);
      }

      return Container(
        color: isDark ? Colors.white.withAlpha(5) : Colors.grey[100],
        child: Center(
          child: Text(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isDark ? Colors.white.withAlpha(30) : Colors.grey[300]!,
            ),
          ),
          child: Text(
            shortcut,
