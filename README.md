...
لبناء Windows، شغّل من جهاز Windows أو استخدم GitHub Actions workflow باسم `Windows Release Build`، والذي يشغل analyze واختبارات platform-stable ثم يرفع artifact باسم `alikhlas-pos-windows`.
