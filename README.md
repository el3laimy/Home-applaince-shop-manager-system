...
لبناء Windows أو Linux من GitHub، استخدم GitHub Actions workflow باسم `Desktop Release Build`، والذي يرفع artifacts باسم `alikhlas-pos-windows` و`alikhlas-pos-linux`.
