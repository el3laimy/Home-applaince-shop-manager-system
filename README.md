...
لبناء Windows، شغّل من جهاز Windows أو استخدم GitHub Actions workflow باسم `Windows Release Build`، والذي يشغل analyze ثم يرفع artifact باسم `alikhlas-pos-windows`.
